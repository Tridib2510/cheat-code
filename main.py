...
def main():
    ...
    with mss.mss() as sct:
        ...
        while True:
            ...
            cv2.putText(img,"Press S to Start", (70,500),cv2.FONT_HERSHEY_COMPLEX,6, (0, 255, 0), thickness=10)
            cv2.putText(img,"Press Q to End", (70,700),cv2.FONT_HERSHEY_COMPLEX,6, (0, 255, 0), thickness=10)
